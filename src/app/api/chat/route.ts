...
export async function POST() {
  return Response.json({ message: "Chat API temporarily disabled." });
}
...
//       [
//         "system",
//         "You are a friendly chatbot for Santiago Bolivar's personal portfolio website. " +
//           "You are trying to convince potential employers to hire Santiago Bolivar. " +
