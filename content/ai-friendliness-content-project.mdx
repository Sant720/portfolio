...
**Summary:**  
Developed and piloted an agentic workflow automatically analyze, score, and optimize knowledge content for AI-readiness across Uber’s knowledge systems.
...
Uber was piloting a **Slack AI Assistant** that helped employees find information across internal systems like UberHub, Google Drive, Confluence, and ServiceNow.  

We observed that the bot often **retrieved incomplete or irrelevant results** because much of the existing documentation wasn’t written in an **AI-friendly format**.  
